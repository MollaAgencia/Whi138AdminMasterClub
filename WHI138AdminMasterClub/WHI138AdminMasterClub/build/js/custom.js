...
function init_daterangepicker() {
    ...
    $('#reportrange span').html(moment().subtract(29, 'days').format('D MMM, YYYY') + ' - ' + moment().format('D MMM, YYYY'));
    ...
    $('#reportrange').on('apply.daterangepicker', function (ev, picker) {
        console.log("apply event fired, start/end dates are " + picker.startDate.format('D MMM, YYYY') + " to " + picker.endDate.format('D MMM, YYYY'));
    });
...
Highcharts.chart('AcessoMensal', {
    ...
    series: [{
        ...
        data: [52, 301, 421, 321, 223, 402, 303, 552, 432, 234, 120, 302]
    }]
});



Highcharts.chart('CadastroMensal', {
    chart: {
        type: 'column'
    },
    title: {
        text: 'Quantidade de Cadastros Mensal'
    },
    xAxis: {
        categories: ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro']
    },
    ...
    series: [{
        ...
        data: [402, 331, 421, 521, 423, 302, 303, 352, 232, 134, 140, 332]
    }]
});
...
$(document).ready(function () {
    ...
    Highcharts.chart('Quantidade_Acessos', {
        chart: {
            zoomType: 'xy'
        },
        title: {
        ...
        xAxis: [{
            categories: ['2018-11-22', '2018-11-23', '2018-11-24', '2018-11-25', '2018-11-26', '2018-11-27',
                '2018-11-28', '2018-11-29', '2018-11-30', '2018-12-01', '2018-12-03', '2018-12-04', '2018-12-05', '2018-12-06', '2018-12-07', '2018-12-08', '2018-12-09', '2018-12-10'],
            crosshair: true
        }],
        yAxis: [{ // Primary yAxis
            labels: {
        ...
        legend: {
            ...
            //(Highcharts.theme && Highcharts.theme.legendBackgroundColor) || 'rgba(255,255,255,0.25)'
        },
        series: [{
            name: 'Acessos Dia a Dia',
            type: 'spline',
            data: [7, 6, 9, 14, 18, 21, 25, 30, 23, 18, 13, 9, 35, 47, 3, 22, 10],
...
if ($("#mybarChartMes").length) {
    var mes = document.getElementById("mybarChartMes");
    new Chart(mes, {
        type: "bar",
        data: {
            ...
            datasets: [{
                ...
                data: [151, 90, 50, 128, 9, 88, 56, 15, 125, 113, 66, 132]
            }]
        },
        options: {
            scales: {
    ...
    new Chart(f, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: "#174f9b",
                data: [51, 30, 40, 28, 92, 50, 45, 10, 25, 13, 60, 112]
            }]
        },
        options: {
            scales: {
...
function init_flot_chart() {
    ...
    var Mes = [
        { 'valor': '105', 'mes': '2018-11-01' },
        { 'valor': '135', 'mes': '2018-11-02' },
        { 'valor': '145', 'mes': '2018-11-03' },
        { 'valor': '125', 'mes': '2018-11-04' },
        { 'valor': '25', 'mes': '2018-11-05' },
        { 'valor': '49', 'mes': '2018-11-06' },
        { 'valor': '50', 'mes': '2018-11-07' },
        { 'valor': '100', 'mes': '2018-11-08' },
        { 'valor': '52', 'mes': '2018-11-09' },
        { 'valor': '63', 'mes': '2018-11-10' },
        { 'valor': '94', 'mes': '2018-11-11' }
        //{ 'valor': '35', 'mes': '2018-11-12' },
        //{ 'valor': '108', 'mes': '2018-11-13' },
        //{ 'valor': '126', 'mes': '2018-11-14' },
        //{ 'valor': '102', 'mes': '2018-11-15' },
        //{ 'valor': '30', 'mes': '2018-11-16' },
        //{ 'valor': '40', 'mes': '2018-11-17' },
        //{ 'valor': '55', 'mes': '2018-11-18' },
        //{ 'valor': '100', 'mes': '2018-11-19' },
        //{ 'valor': '120', 'mes': '2018-11-20' },
        //{ 'valor': '88', 'mes': '2018-11-21' },
        //{ 'valor': '72', 'mes': '2018-11-22' },
        //{ 'valor': '66', 'mes': '2018-11-23' },
        //{ 'valor': '200', 'mes': '2018-11-24' },
        //{ 'valor': '67', 'mes': '2018-11-25' },
        //{ 'valor': '293', 'mes': '2018-11-26' },
        //{ 'valor': '115', 'mes': '2018-11-27' },
        //{ 'valor': '88', 'mes': '2018-11-28' },
        //{ 'valor': '29', 'mes': '2018-11-29' },
        //{ 'valor': '39', 'mes': '2018-11-30' }
    ];
    //, randNum() + i + i + 10])
    for (var i = 0; i < Mes.length; i++) {
        chart_plot_02_data.push([new Date(Mes[i].mes), parseInt(Mes[i].valor)]);
    }
