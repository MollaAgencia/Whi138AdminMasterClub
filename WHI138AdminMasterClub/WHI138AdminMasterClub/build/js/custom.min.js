...
function init_chart_doughnut() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = {
            ...
            data: {
                labels: ["Visualizado", "Não Visualizado"],
                datasets: [{
                    data: [15, 20, 30, 10, 30],
    ...
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
            ...
            new Chart(mes, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [151, 90, 50, 128, 9, 88, 56, 15, 125, 113, 66, 32]
                    }]
                },
                options: {
                    scales: {
            ...
            new Chart(f, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [51, 30, 40, 28, 92, 50, 45, 10, 25, 13, 60, 12]
                    }]
                },
                options: {
                    scales: {
        ...
        if ($("#canvasDoughnut").length) {
            var f = document.getElementById("canvasDoughnut"),
                i = {
                    labels: ["XPTO", "XPTO2", "XPTO3", "XPTO4", "XPTO5"],
                    datasets: [{
                        data: [120, 50, 30, 100, 90],
                        backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
                        hoverBackgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"]
                    }]
                };
            new Chart(f, {
                type: "doughnut",
...
function init_morris_charts() {
    "undefined" != typeof Morris && (console.log("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
        ...
        $("#graph_donut_video").length && Morris.Donut({
            element: "graph_donut_video",
            data: [{
                label: "Distribuidor 01",
                value: 27
            }, {
                label: "Distribuidor 02",
                value: 50
            }, {
                label: "Distribuidor 03",
                value: 30
            }, {
                label: "Distribuidor 04",
                value: 100
            },
            {
                label: "Distribuidor 05",
                value: 90
            }],
